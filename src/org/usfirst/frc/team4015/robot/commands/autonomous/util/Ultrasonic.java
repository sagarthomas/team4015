...
import org.usfirst.frc.team4015.robot.commands.autonomous.util.Ultrasonic.UltrasonicChecker;
...
public class Ultrasonic extends SensorBase implements PIDSource, LiveWindowSendable {
	...
	private static DigitalOutput m_pingChannel = new DigitalOutput(RobotMap.DigitalOut.DO1);
	 ...
	 */
	 public class UltrasonicChecker extends Thread {
		...
		public synchronized void run() {
			...
			while (m_automaticEnabled) {
				...
				if (u.isEnabled()) {
					u.m_pingChannel.pulse(RobotMap.DigitalOut.DO1,
	 ...
	 */
	public Ultrasonic(final int echoChannel, Unit units) {
		//m_pingChannel = new DigitalOutput(pingChannel);
		//m_pingChannel = new DigitalOutput(RobotMap.DigitalOut.DO1);
	 ...
	 *            of the ping, and the distance.
	 */
	public Ultrasonic(final int echoChannel) {
	...
	public void ping() {
		...
		m_pingChannel.pulse(RobotMap.DigitalOut.DO1, (float) kPingTime); // do
																			// the
																			// ping
																			// to
																			// start
